...
DDcode <- nimbleCode({
  ...
  N1ad.p~T(dnorm(10,0.01),0,)
  N1ad.v~T(dnorm(100,0.01),0,)
  N1rec.p~T(dnorm(10,0.01),0,)
...
nodesToSim <- DDmodel$getDependencies(c("dd.phi.p","dd.fledg.rate.v","p.p","p.v","mu.phi.p","mu.phi.v","mu.fledg.rate.p","mu.fledg.rate.v","N1rec.v","N1rec.p","N1ad.v","N1ad.p"),
                                      self = F, downstream = T)
#Compile the model 
...
save(list.simul,file="simul_BG2019_dd_obserror_nointer.Rdata")
load("simul_BG2019_dd_obserror_nointer.Rdata")
...
DDinits<-list(dd.phi.v=0,dd.fledg.rate.p=0,dd.phi.p=-0.01,dd.fledg.rate.v=-0.005,mu.phi.p=c(0.5,qlogis(0.7)),mu.phi.v=c(0.5,qlogis(0.6)),p.p=0.7,p.v=0.7,mu.fledg.rate.p=0.5,mu.fledg.rate.v=1.5,N1rec.p=N1rec.p,N1ad.p=N1ad.p,N1rec.v=N1rec.v,N1ad.v=N1ad.v)


#Build the model for the IPM
DDmodelIPM <- nimbleModel(DDcode,
                          constants = DDconstants,data=DDdata,inits = DDinits,calculate = FALSE)
...
#configure the MCMC
DDmcmcConf <- configureMCMC(cDDmodelIPM,useConjugacy = FALSE,monitors=c("dd.phi.p","dd.phi.v","dd.fledg.rate.p","dd.fledg.rate.v","N.p","N.v","N.ad.p","N.ad.v","N.rec.p","N.rec.v","p.p","p.v","fledg.rate.p","fledg.rate.v","phi.p","phi.v","mu.fledg.rate.p","mu.fledg.rate.v","mu.phi.p","mu.phi.v"))
...
save(list.samples,file="samples_BG2019_dd_obserror_nointer.Rdata")
...
load(file="samples_BG2019_dd_obserror_nointer.Rdata")
