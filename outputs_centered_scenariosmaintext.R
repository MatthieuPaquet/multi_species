...
if (STOCH) {
  if (DD_INTER) {
load(file="samples_BG2019_dd_centered_time30_ddinter_stoch.Rdata")
load(file="simul_BG2019_dd_centered_time30_ddinter_stoch.Rdata")
  } else {
    load(file="samples_BG2019_dd_centered_time30_noddinter_stoch.Rdata")
    load(file="simul_BG2019_dd_centered_time30_noddinter_stoch.Rdata")
  }
} else {
  if (DD_INTER) {
  load(file="samples_BG2019_dd_centered_time30_ddinter_nostoch.Rdata")
  load(file="simul_BG2019_dd_centered_time30_ddinter_nostoch.Rdata")
  } else {
