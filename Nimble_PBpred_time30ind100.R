...
for (i in 1:100) {
  ...
  list.simul[[i]] <- list(N.rec.p=cDDmodel$N.rec.p,N.ad.p=cDDmodel$N.ad.p,
                          ...
                          marray.a.p=cDDmodel$marray.a.p,r.a.p=cDDmodel$r.a.p, 
...
for (i in 1) {
  ...
  marray.j.p <- matrix(NA,(nyears-1),nyears)
  marray.j.v <- matrix(NA,(nyears-1),nyears)
  marray.j.p[1:(nyears-1),1:(nyears-1)] <- list.simul[[i]]$marray.j.p[1:(1 + nyears-2),
                                                                      1:(1 + nyears-2)]
  marray.j.p[,nyears] <- list.simul[[i]]$marray.j.p[1:(1 + nyears-2),
                                                    (1 + nyears-1):dim(list.simul[[i]]$marray.j.p)[2]]
  marray.j.v[1:(nyears-1),1:(nyears-1)] <- list.simul[[i]]$marray.j.v[1:(1 + nyears-2),
                                                                      1:(1 + nyears-2)]
  marray.j.v[,nyears] <- list.simul[[i]]$marray.j.v[1:(1 + nyears-2),
                                                    (1 + nyears-1):dim(list.simul[[i]]$marray.j.v)[2]]
  marray.a.p <- matrix(NA,(nyears-1),nyears)
  marray.a.v <- matrix(NA,(nyears-1),nyears)
  marray.a.p[1:(nyears-1),1:(nyears-1)] <- list.simul[[i]]$marray.a.p[1:(1 + nyears-2),
                                                                      1:(1 + nyears-2)]
  marray.a.p[,nyears] <- list.simul[[i]]$marray.a.p[1:(1 + nyears-2),
                                                    (1 + nyears-1):dim(list.simul[[i]]$marray.a.p)[2]]
  marray.a.v[1:(nyears-1),1:(nyears-1)] <- list.simul[[i]]$marray.a.v[1:(1 + nyears-2),
                                                                      1:(1 + nyears-2)]
  marray.a.v[,nyears] <- list.simul[[i]]$marray.a.v[1:(1 + nyears-2),
                                                    (1 + nyears-1):dim(list.simul[[i]]$marray.a.v)[2]]
  N.obs.p <- list.simul[[i]]$N.obs.p[1:(1 + nyears-1)]
  fledg.obs.p <- list.simul[[i]]$fledg.obs.p[1:(1 + nyears-1)]
  N.obs.v <- list.simul[[i]]$N.obs.v[1:(1 + nyears-1)]
  fledg.obs.v <- list.simul[[i]]$fledg.obs.v[1:(1 + nyears-1)]
}
DDconstants <- list(N.rec.v.star=101,N.ad.v.star=152,N.ad.p.star=21,nyears=nyears,
                    r.j.p=r.j.p,
                    r.j.v=r.j.v,
                    fledg.sample.v=fledg.sample.v,
                    fledg.sample.p=fledg.sample.p)
DDdata <- list(r.a.p=r.a.p,r.a.v=r.a.v,
               marray.j.p=marray.j.p,marray.a.p=marray.a.p,
