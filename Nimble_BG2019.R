...
DDcode <- nimbleCode({
  ...
  for (t in 1:nyears){
    #Observation process
    N.obs.p[t]~dnorm(N.p[t],100000)
    N.obs.v[t]~dnorm(N.v[t],100000)
  # System process
...
save(list.simul,file="simul_BG2019_dd01.Rdata")
load("simul_BG2019_dd01.Rdata")
...
#Set data and initial values
DDmodel$setData(list(marray.j.p=marray.j.p,N.obs.p=N.obs.p,fledg.obs.p=fledg.obs.p,marray.j.v=marray.j.v,N.obs.v=N.obs.v,fledg.obs.v=fledg.obs.v))
DDmodel$setInits(list(dd.phi.p=-0.01,dd.fledg.rate.v=-0.005,mu.phi.p=c(0.5,qlogis(0.7)),mu.phi.v=c(0.5,qlogis(0.6)),p.p=0.7,p.v=0.7,mu.fledg.rate.p=0.5,mu.fledg.rate.v=1.5,N1rec.p=N1rec.p,N1ad.p=N1ad.p,N1rec.v=N1rec.v,N1ad.v=N1ad.v))
...
save(list.simul,file="simul_BG2019_nodd.Rdata")
load("simul_BG2019_nodd.Rdata")
...
save(list.samples,file="samples_BG2019_dd01.Rdata")
...
load(file="samples_BG2019_dd01.Rdata")